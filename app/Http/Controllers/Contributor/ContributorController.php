...
class ContributorController extends Controller
{
    ...
    public function index()
    {
        ...
        // Return the contributor dashboard view with the projects data
        return view('contributor.dashboard', compact('projects'));
    }
    ...
    public function activity_logs(Request $request)
{
    ...
    return view('contributor.activity_logs.index', compact('activityLogs'));
}
