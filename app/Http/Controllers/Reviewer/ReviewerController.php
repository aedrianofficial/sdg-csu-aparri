...
class ReviewerController extends Controller
{
    ...
    public function index()
    {
        ...
        // Return the reviewer dashboard view with the projects data
        return view('reviewer.dashboard', compact('projects'));
    }
    public function activity_logs(Request $request)
{
    ...
    return view('reviewer.activity_logs.index', compact('activityLogs'));
}
