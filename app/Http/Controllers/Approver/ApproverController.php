    ...
    public function index()
{
    ...
    // Return the approver dashboard view with the projects data
    return view('approver.dashboard', compact('projects'));
}
...
public function activity_logs(Request $request)
{
    ...
    return view('approver.activity_logs.index', compact('activityLogs'));
}
    /**
