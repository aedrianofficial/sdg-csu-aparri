...
@section('title', 'My Research Lists')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('research.my_research') }}" method="GET" class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12 text-left">
                                        ...
                                        <a href="{{ route('research.my_research') }}" class="btn btn-secondary">Reset</a>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <table id="research-table" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>
                                                    <a
                                                        href="{{ route('research.my_research', array_merge(request()->query(), ['sort_by' => 'title', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])) }}">
                                                        Title
                                                ...
                                                <th>
                                                    <a
                                                        href="{{ route('research.my_research', array_merge(request()->query(), ['sort_by' => 'researchcategory_id', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])) }}">
                                                        Research Categories
                                                ...
                                                <th>
                                                    <a
                                                        href="{{ route('research.my_research', array_merge(request()->query(), ['sort_by' => 'review_status_id', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])) }}">
                                                        Review Status
                                                ...
                                                <th>
                                                    <a
                                                        href="{{ route('research.my_research', array_merge(request()->query(), ['sort_by' => 'status_id', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])) }}">
                                                        Research Status
                                                ...
                                                <th>
                                                    <a
                                                        href="{{ route('research.my_research', array_merge(request()->query(), ['sort_by' => 'created_at', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])) }}">
                                                        Created At
