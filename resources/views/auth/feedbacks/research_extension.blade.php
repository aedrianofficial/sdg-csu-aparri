...
@section('title', 'Need Changes Research')
@section('content')
...
@endif
                                ...
                                <a href="{{ route('contributor.research.edit', $research->id) }}"
                                    class="btn btn-sm btn-info">Edit Research Content</a>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="content-wrapper">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('research.index') }}">My Research</a>
                        </li>
...
@endforeach
                            ...
                            <a href="{{ route('research.edit', $research->id) }}" class="btn btn-sm btn-info">Edit
                                Research Content</a>
                        </form>
                    </div>
                </div>
