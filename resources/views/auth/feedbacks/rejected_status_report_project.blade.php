...
@section('title', 'View Status Report for "' . $statusReport->related_title . '"')
@section('content')
                            ...
                            <form action="" class="forms-sample">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="related_type" id="related_type" class="form-control"
                                        value="{{ $statusReport->related_type === 'App\\Models\\Project' ? 'Project' : $statusReport->related_type ?? 'N/A' }}"
                                        readonly>
                                </div>
                                <!-- Related Link -->
                                <div class="mb-3">
