...
@section('content')
    ...
    <div class="main-body">
        <div class="row gutters-sm">
            ...
            <div class="col-md-8">
                <form action="{{ route('auth.profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card card-primary card-outline">
                        <div class="card-body">
        ...
        document.getElementById('cancelButton').addEventListener('click', function() {
            if (isDirty) {
                ...
                if (confirm(confirmationMessage)) {
                    ...
                    window.location.href = '{{ route('auth.dashboard') }}'; // Redirect to home or desired route
                }
            } else {
                window.location.href = '{{ route('auth.dashboard') }}'; // Redirect to home or desired route
            }
