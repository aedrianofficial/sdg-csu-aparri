                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end shadow">
                                ...
                                @php
                                    ...
                                    if ($data['type'] === 'project') {
                                        if ($data['status'] === 'request_changes') {
                                            $route = route('contributor.projects.request_changes.show', [
                                                'id' => $notification->related_id,
                                                'notification_id' => $notification->id,
                                            ]);
                                        } elseif ($data['status'] === 'rejected') {
                                            $route = route('contributor.projects.rejected.show', [
                                                'id' => $notification->related_id,
                                                'notification_id' => $notification->id,
                                            ]);
                                        } elseif (in_array($data['status'], ['approved', 'published', 'reviewed'])) {
                                            $route = route('contributor.projects.show', [
                                                'id' => $notification->related_id,
                                                'notification_id' => $notification->id,
                                            ]);
                                        }
                                        ...
                                        if ($data['status'] === 'request_changes') {
                                            $route = route('contributor.research.request_changes.show', [
                                                'id' => $notification->related_id,
                                                'notification_id' => $notification->id,
                                            ]);
                                        } elseif ($data['status'] === 'rejected') {
                                            $route = route('contributor.research.rejected.show', [
                                                'id' => $notification->related_id,
                                                'notification_id' => $notification->id,
                                            ]);
                                        } elseif (in_array($data['status'], ['approved', 'published', 'reviewed'])) {
                                            $route = route('contributor.research.show', [
                                                'id' => $notification->related_id,
                                                'notification_id' => $notification->id,
                                            ]);
                                        }
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="{{ route('contributor.notifications') }}"
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-footer">
                                <a href="{{ route('contributor.profile.show', ['id' => Auth::user()->id]) }}"
