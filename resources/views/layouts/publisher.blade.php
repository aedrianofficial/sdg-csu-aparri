                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end shadow">
                            ...
                            @forelse (auth()->user()->notifications()->latest()->take(4)->get() as $notification)
                                @php
                                    ...
                                    // Determine the appropriate route based on type and status for publishers
                                    $route = '';
                                    if ($data['type'] === 'project' && $data['status'] === 'submitted for publishing') {
                                        $route = route('publisher.projects.show', [
                                        ...
                                        $route = route('publisher.research.show', [
                                            'id' => $notification->related_id,
                                            'notification_id' => $notification->id,
                                        ]);
                                    }
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="{{ route('publisher.notifications') }}"
                                class="dropdown-item text-center text-primary">
                                <strong>See All Notifications</strong>
                            </a>
                        </div>
                    </li>
                    <!--end::Notifications Dropdown Menu for Publisher-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-footer">
                                <a href="{{ route('publisher.profile.show', ['id' => Auth::user()->id]) }}"
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item {{ request()->routeIs('publisher.projects.*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ request()->routeIs('publisher.projects.*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('publisher.projects.index') }}"
                                        class="nav-link {{ request()->routeIs('publisher.projects.index') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Contents for Publishing</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('publisher.projects.published_list') }}"
                                        class="nav-link {{ request()->routeIs('publisher.projects.published_list') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                        ...
                        <li class="nav-item {{ request()->routeIs('publisher.research.*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ request()->routeIs('publisher.research.*') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-box-seam-fill"></i>
                                <p>
                                    Research & Extension
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('publisher.research.index') }}"
                                        class="nav-link {{ request()->routeIs('publisher.research.index') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Contents for Publishing</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('publisher.research.published_list') }}"
                                        class="nav-link {{ request()->routeIs('publisher.research.published_list') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Published Content</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('publisher.activity_logs') }}" class="nav-link">
                                <i class="nav-icon bi bi-palette"></i>
                                <p>Activity Logs</p>
                            </a>
                        </li>
