...
<head>
    ...
    <title>@yield('title', 'Approver')</title>
        ...
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <!--begin::Notifications Dropdown Menu for Approver-->
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end shadow">
                            ...
                            @forelse (auth()->user()->notifications()->latest()->take(4)->get() as $notification)
                                @php
                                    ...
                                    // Determine the appropriate route based on type and status for approvers
                                    $route = '';
                                    if ($data['type'] === 'project' && $data['status'] === 'submitted for approval') {
                                        $route = route('approver.projects.show', [
                                        ...
                                        $route = route('approver.reports.show', [
                                            'id' => $notification->related_id,
                                            'notification_id' => $notification->id,
                                        ]);
                                    } elseif (
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="{{ route('approver.notifications') }}"
                                class="dropdown-item text-center text-primary">
                                <strong>See All Notifications</strong>
                            </a>
                        </div>
                    </li>
                    <!--end::Notifications Dropdown Menu for Approver-->
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('approver.dashboard') }}" class="nav-link">
                                <i class="nav-icon bi bi-palette"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>

                        <li class="nav-item {{ request()->routeIs('approver.projects.*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ request()->routeIs('approver.projects.*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('approver.projects.index') }}"
                                        class="nav-link {{ request()->routeIs('approver.projects.index') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Pending Approval</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('approver.projects.approved_list') }}"
                                        class="nav-link {{ request()->routeIs('approver.projects.approved_list') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Approved list</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('approver.projects.rejected') }}"
                                        class="nav-link {{ request()->routeIs('approver.projects.rejected') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Rejected</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ request()->routeIs('approver.status_reports.*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ request()->routeIs('approver.status_reports.*') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-box-seam-fill"></i>
                                <p>
                                    Status Reports
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('approver.status_reports.index') }}"
                                        class="nav-link {{ request()->routeIs('approver.status_reports.index') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Pending Approval</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('approver.status_reports.approved_list') }}"
                                        class="nav-link {{ request()->routeIs('approver.status_reports.approved_list') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Approved list</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('approver.status_reports.rejected_list') }}"
                                        class="nav-link {{ request()->routeIs('approver.status_reports.rejected_list') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Rejected</p>
                                    </a>
                                </li>
                        ...
                        <li
                            class="nav-item {{ request()->routeIs('approver.terminal_reports.*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ request()->routeIs('approver.terminal_reports.*') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-box-seam-fill"></i>
                                <p>
                                    Terminal Reports
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('approver.terminal_reports.index') }}"
                                        class="nav-link {{ request()->routeIs('approver.terminal_reports.index') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Pending Approval</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('approver.terminal_reports.approved_list') }}"
                                        class="nav-link {{ request()->routeIs('approver.terminal_reports.approved_list') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Approved list</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('approver.terminal_reports.rejected_list') }}"
                                        class="nav-link {{ request()->routeIs('approver.terminal_reports.rejected_list') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Rejected</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ request()->routeIs('approver.research.*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ request()->routeIs('approver.research.*') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-box-seam-fill"></i>
                                <p>
                                    Research & Extension
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('approver.research.index') }}"
                                        class="nav-link {{ request()->routeIs('approver.research.index') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Pending Approval</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('approver.research.approved_list') }}"
                                        class="nav-link {{ request()->routeIs('approver.research.approved_list') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Approved list</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('approver.research.rejected') }}"
                                        class="nav-link {{ request()->routeIs('approver.research.rejected') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Rejected</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('approver.activity_logs') }}" class="nav-link">
                                <i class="nav-icon bi bi-palette"></i>
                                <p>Activity Logs</p>
                            </a>
                        </li>
