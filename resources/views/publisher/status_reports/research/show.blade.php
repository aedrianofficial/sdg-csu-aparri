                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#confirmPublishedModal{{ $statusReport->id }}">Publish</button>

                            </div>

                            <!-- 'Published' Modal -->
                            <div class="modal fade" id="confirmPublishedModal{{ $statusReport->id }}" tabindex="-1"
                                aria-labelledby="confirmPublisherModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="confirmPublisherModalLabel">Confirm Publish</h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form
                                                action="{{ route('publisher.status_reports.published', $statusReport->id) }}"
