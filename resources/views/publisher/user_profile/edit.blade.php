...
@section('styles')
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-CQP51Hjge4eFMo90nNJixFqICXLUvMAjsF8eiKA/eHI6vFR9FZGn0BoM0zxAFIrk" crossorigin="anonymous">
...
@section('content')
    ...
    <div class="main-body">
        <div class="row gutters-sm">
            ...
            <div class="col-md-8">
                <form action="{{ route('publisher.profile.update', $user->id) }}" method="POST"
