...
@section('title', 'Published Project/Program Lists')
@section('content')
    <div class="app-content-header"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Published Projects/Programs</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="{{ route('publisher.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">
                            Published Projects/Programs
                        </li>
                    </ol>
                </div>
            </div> <!--end::Row-->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('publisher.projects.published_list') }}" method="GET" class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select id="project_status" name="project_status" class="form-select select2">
                                            ...
                                            <option value="Proposed"
                                                {{ request('project_status') == 'Proposed' ? 'selected' : '' }}>
                                                Proposed
                                            </option>
                                            <option value="On-Going"
                                                {{ request('project_status') == 'On-Going' ? 'selected' : '' }}>
                                                On-Going
                                            </option>
                                            <option value="On-Hold"
                                                {{ request('project_status') == 'On-Hold' ? 'selected' : '' }}>
                                                On-Hold
                                            </option>
                                            ...
                                            <option value="Rejected"
                                                {{ request('project_status') == 'Rejected' ? 'selected' : '' }}>
                                                Rejected
                                            </option>
                                        </select>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($projectsPaginated as $project)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('publisher.projects.show_published', $project->id) }}"
