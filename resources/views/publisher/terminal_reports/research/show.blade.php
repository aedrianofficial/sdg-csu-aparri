                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#confirmPublishModal{{ $terminalReport->id }}">Published</button>

                            </div>

                            <!-- 'Published' Modal -->
                            <div class="modal fade" id="confirmPublishModal{{ $terminalReport->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form
                                                action="{{ route('publisher.terminal_reports.published', $terminalReport->id) }}"
