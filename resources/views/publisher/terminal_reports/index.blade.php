                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('publisher.terminal_reports.index') }}" method="GET"
                                class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                        ...
                                        <tbody>
                                            @foreach ($reports as $report)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($report->related_type === App\Models\Project::class)
                                                            <a href="{{ route('publisher.terminal_reports.show_project', $report->id) }}"
                                                                class="btn btn-sm btn-success">View</a>
                                                        @elseif ($report->related_type === App\Models\Research::class)
                                                            <a href="{{ route('publisher.terminal_reports.show_research', $report->id) }}"
                                                                class="btn btn-sm btn-success">View</a>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-primary"
                                                            ...
                                                            data-bs-target="#confirmPublishModal{{ $report->id }}">Published</button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                            ...
                            @foreach ($reports as $report)
                                <!-- 'Published' Modal -->
                                <div class="modal fade" id="confirmPublishModal{{ $report->id }}" tabindex="-1"
                                    aria-labelledby="confirmPublishModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="confirmPublishModalLabel">Confirm Publish</h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('publisher.terminal_reports.published', $report->id) }}"
