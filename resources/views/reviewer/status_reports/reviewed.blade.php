...
@section('content')
    <div class="app-content-header"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Reviewed Status Reports</h3>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('reviewer.status_reports.reviewed_list') }}" method="GET"
                                class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($report->related_type === App\Models\Project::class)
                                                            <a href="{{ route('reviewer.status_reports.show_reviewed_project', $report->id) }}"
                                                                class="btn btn-sm btn-success">View</a>
                                                        @elseif ($report->related_type === App\Models\Research::class)
                                                            <a href="{{ route('reviewer.status_reports.show_reviewed_research', $report->id) }}"
                                                                class="btn btn-sm btn-success">View</a>
                                                        @endif
                                                    </td>
