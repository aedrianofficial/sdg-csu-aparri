                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal"
                                    data-bs-target="#needChangesModal{{ $statusReport->id }}">
                                    Need Changes</button>
                                ...
                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#confirmReviewModal{{ $statusReport->id }}">Reviewed</button>

                            </div>

                            <!-- 'Reviewed' Modal -->
                            <div class="modal fade" id="confirmReviewModal{{ $statusReport->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form
                                                action="{{ route('reviewer.status_reports.reviewed', $statusReport->id) }}"
                            ...
                            <!-- 'Need Changes' Modal -->
                            <div class="modal fade" id="needChangesModal{{ $statusReport->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('reviewer.status_reports.needchanges') }}" method="POST">
                                            @csrf
                            ...
                            <div class="modal fade" id="rejectModal{{ $statusReport->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('reviewer.status_reports.reject') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="status_report_id"
                                                value="{{ $statusReport->id }}">
                                            <div class="modal-body">
