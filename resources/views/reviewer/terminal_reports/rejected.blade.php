                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('reviewer.terminal_reports.rejected_list') }}" method="GET"
                                class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                        ...
                                        <tbody>
                                            @foreach ($reports as $report)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($report->related_type === App\Models\Project::class)
                                                            <a href="{{ route('reviewer.terminal_reports.project_rejected', $report->id) }}"
                                                                class="btn btn-sm btn-success">View</a>
                                                        @elseif ($report->related_type === App\Models\Research::class)
                                                            <a href="{{ route('reviewer.terminal_reports.research_rejected', $report->id) }}"
                                                                class="btn btn-sm btn-success">View</a>
                                                        @endif
                                                    </td>
                                                </tr>
