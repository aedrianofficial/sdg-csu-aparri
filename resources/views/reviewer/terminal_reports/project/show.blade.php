                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="" class="forms-sample">
                             ...
                             <div class="mb-3">
                                ...
                                <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal"
                                    data-bs-target="#needChangesModal{{ $terminalReport->id }}">
                                    Need Changes</button>
                                ...
                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#confirmReviewModal{{ $terminalReport->id }}">Reviewed</button>

                            </div>

                            <!-- 'Reviewed' Modal -->
                            <div class="modal fade" id="confirmReviewModal{{ $terminalReport->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form
                                                action="{{ route('reviewer.terminal_reports.reviewed', $terminalReport->id) }}"
                            ...
                            <!-- 'Need Changes' Modal -->
                            <div class="modal fade" id="needChangesModal{{ $terminalReport->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('reviewer.terminal_reports.needchanges') }}" method="POST">
                                            @csrf
