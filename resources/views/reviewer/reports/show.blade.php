                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                                        data-bs-target="#needChangesReportModal">
                                        Need Changes
                                    </button>
                                    ...
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                        data-bs-target="#confirmReviewReportModal">
                                        Reviewed
                                    </button>
                                </div>

                                <!-- 'Need Changes' Modal -->
                                <div class="modal fade" id="needChangesReportModal" tabindex="-1"
                                    aria-labelledby="needChangesReportModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="needChangesReportModalLabel">Need Changes
                                                    Feedback</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <form action="{{ route('reviewer.reports.needchanges') }}" method="POST">
                                                @csrf
                                ...
                                <div class="modal fade" id="rejectReportModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('reviewer.reports.reject') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="report_id" value="{{ $report->id }}">
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                ...
                                <!-- Confirmation Modal for Reviewed Report -->
                                <div class="modal fade" id="confirmReviewReportModal" tabindex="-1"
                                    aria-labelledby="confirmReviewReportModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="confirmReviewReportModalLabel">Confirm Review
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('reviewer.reports.reviewed', $report->id) }}"
