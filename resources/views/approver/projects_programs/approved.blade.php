...
@section('title', 'Approved Project/Program Lists')
@section('content')
    <div class="app-content-header"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Approved Projects/Programs</h3>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('approver.projects.approved_list') }}" method="GET" class="mb-4">
                                    <div class="row">
                                        <!-- Title Filter -->
                                            ...
                                            <tbody>
                                                @foreach ($projectsPaginated as $project)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('approver.projects.show_approved', $project->id) }}"
