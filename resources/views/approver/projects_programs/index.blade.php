...
@section('title', 'Pending Approval for Project/Program Lists')
@section('content')
    <div class="app-content-header"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Pending Approval for Projects/Programs</h3>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('approver.projects.index') }}" method="GET" class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                            ...
                                            @foreach ($projects as $project)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="rejectModal{{ $project->id }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ route('approver.projects.reject') }}"
                                                                        method="POST">
                                                                        @csrf
                                                        ...
                                                        <!-- 'Approve' Modal -->
                                                        <div class="modal fade" id="approveModal{{ $project->id }}"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                            data-bs-dismiss="modal">Close</button>
                                                                        <form
                                                                            action="{{ route('approver.projects.approved', $project->id) }}"
