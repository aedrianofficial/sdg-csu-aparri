                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('approver.status_reports.index') }}" method="GET"
                                class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($report->related_type === App\Models\Project::class)
                                                            <a href="{{ route('approver.status_reports.show_project', $report->id) }}"
                                                                class="btn btn-sm btn-success">View</a>
                                                        @elseif ($report->related_type === App\Models\Research::class)
                                                            <a href="{{ route('approver.status_reports.show_research', $report->id) }}"
                                                                class="btn btn-sm btn-success">View</a>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-primary"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#confirmApproveModal{{ $report->id }}">Approved</button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                            ...
                            @foreach ($reports as $report)
                                <!-- 'Approved' Modal -->
                                <div class="modal fade" id="confirmApproveModal{{ $report->id }}" tabindex="-1"
                                    aria-labelledby="confirmApproveModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="confirmApproveModalLabel">Confirm Review</h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form
                                                    action="{{ route('approver.status_reports.approved', $report->id) }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('approver.status_reports.reject') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="status_report_id" value="{{ $report->id }}">
                                                <div class="modal-body">
                                                    <div class="mb-3">
