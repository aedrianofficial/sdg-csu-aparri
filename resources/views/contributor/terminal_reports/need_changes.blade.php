                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('contributor.terminal_reports.need_changes') }}" method="GET" class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($report->reviewStatus && $report->reviewStatus->status === 'Need Changes')
                                                            @if ($report->related_type === App\Models\Project::class)
                                                                <a href="{{ route('contributor.terminal_reports.projects.need_changes', $report->id) }}"
                                                                    class="btn btn-sm btn-success">View</a>
                                                            @elseif ($report->related_type === App\Models\Research::class)
                                                                <a href="{{ route('contributor.terminal_reports.research.need_changes', $report->id) }}"
                                                                    class="btn btn-sm btn-success">View</a>
                                                            @endif
                                                        @elseif ($report->reviewStatus && $report->reviewStatus->status === 'Rejected')
                                                            @if ($report->related_type === App\Models\Project::class)
                                                                <a href="{{ route('contributor.terminal_reports.projects.rejected', $report->id) }}"
                                                                    class="btn btn-sm btn-success">View</a>
                                                            @elseif ($report->related_type === App\Models\Research::class)
                                                                <a href="{{ route('contributor.terminal_reports.research.rejected', $report->id) }}"
                                                                    class=" btn btn-sm btn-success">View</a>
                                                            @endif
                                                        @else
                                                            @if ($report->related_type === App\Models\Project::class)
                                                                <a href="{{ route('contributor.terminal_reports.show_project_published', $report->id) }}"
                                                                    class="btn btn-sm btn-success">View</a>
                                                            @elseif ($report->related_type === App\Models\Research::class)
                                                                <a href="{{ route('contributor.terminal_reports.show_research_published', $report->id) }}"
                                                                    class="btn btn-sm btn-success">View</a>
                                                            @endif
                                                        @endif
                                                    </td> 
                                                    <td>
                                                        <a href="{{ route('contributor.terminal_reports.edit', $report->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                    </td>                                        
                                                </tr>
                                            @endforeach
                                        </tbody>
