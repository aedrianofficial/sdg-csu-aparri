...
@section('title', 'Need Changes Project/Program ')
@section('styles')
    <style>
        #map {
            height: 400px;
...
@endif
                                ...
                                <a href="{{ route('contributor.projects.edit', $project->id) }}"
                                    class="btn btn-sm btn-info">Edit Project/Program Content</a>
                            </div>
                        </div>
                    </div>
                </div>
