...
@section('title', 'Rejected Research Lists')
        ...
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row"> <!--begin::Col-->
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Rejected Research</h4>

                            <!-- Search and Filter Form -->
                            <form action="{{ route('contributor.research.rejected') }}" method="GET" class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                        ...
                                        <tbody>
                                            @foreach ($researches as $research)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('contributor.research.rejected.show', $research->id) }}"
