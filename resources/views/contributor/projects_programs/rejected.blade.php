...
@section('title', 'Need Project/Program Lists')
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('contributor.projects.rejected') }}" method="GET" class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                        ...
                                        <tbody>
                                            @foreach ($projects as $project)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('contributor.projects.rejected.show', $project->id) }}"
