...
@endif
                                ...
                                <div class="mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <ul class="list-group mb-3">
                                                            <li
                                                                class="list-group-item {{ $project->genderImpact->benefits_women ? 'list-group-item-success' : 'list-group-item-light' }}">
                                                                <i
                                                                    class="fas {{ $project->genderImpact->benefits_women ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' }} me-2"></i>
                                                                Benefits Women/Girls
                                                                @if ($project->genderImpact->women_count)
                                                                    <span
                                                                        class="badge bg-info ms-2">{{ $project->genderImpact->women_count }}
                                                                        mentioned</span>
                                                                @endif
                                                            </li>
                                                            <li
                                                                class="list-group-item {{ $project->genderImpact->benefits_men ? 'list-group-item-success' : 'list-group-item-light' }}">
                                                                <i
                                                                    class="fas {{ $project->genderImpact->benefits_men ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' }} me-2"></i>
                                                                Benefits Men/Boys
                                                                @if ($project->genderImpact->men_count)
                                                                    <span
                                                                        class="badge bg-info ms-2">{{ $project->genderImpact->men_count }}
                                                                        mentioned</span>
                                                                @endif
                                                            </li>
                                                            <li
                                                                class="list-group-item {{ $project->genderImpact->benefits_all ? 'list-group-item-success' : 'list-group-item-light' }}">
                                                                <i
                                                                    class="fas {{ $project->genderImpact->benefits_all ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' }} me-2"></i>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card h-100">
                                                            <div class="card-body">
                                                                ...
                                                                <p class="card-text">
                                                                    <span
                                                                        class="badge {{ $project->genderImpact->addresses_gender_inequality ? 'bg-success' : 'bg-secondary' }} p-2">
                                                                        <i
                                                                            class="fas {{ $project->genderImpact->addresses_gender_inequality ? 'fa-check' : 'fa-times' }} me-1"></i>
                                    ...
                                    @else
                                        <div class="alert alert-secondary">
                                            <i class="fas fa-info-circle me-2"></i>No gender impact analysis available for
                                            this project.
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="location_address" id="location_address"
                                        class="form-control" value="{{ $project->location_address }}" readonly>
                                </div>
                                ...
                                <!-- Map Container -->
                                <div class="mb-3" style="height: 400px; margin-top: 20px;" id="map"></div>
