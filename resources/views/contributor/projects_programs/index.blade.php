...
@section('content')
    <div class="app-content-header"> <!--begin::Container-->
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">My Projects/Programs</h3>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('contributor.projects.index') }}" method="GET" class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                        ...
                                        <tbody>
                                            @foreach ($projects as $project)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('contributor.projects.show', $project->id) }}"
                                                            class="btn btn-sm btn-success">View</a>
                                                        {{-- <a href="{{ route('contributor.projects.edit', $project->id) }}"
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif (in_array($project->status_id, array_keys($statusesToCheckForStatusReport)) &&
                                                            ...
                                                            <a href="{{ route('contributor.status_reports.create_project', [
                                                        ...
                                                        @elseif ($project->status_id == 4 && $project->is_publish == 1)
                                                            ...
                                                            @if (!$currentTerminalReportExists)
                                                                <a href="{{ route('contributor.terminal_reports.create_project', [
                                                                    'related_type' => App\Models\Project::class,
                                                                    'related_id' => $project->id,
                                                                    'related_title' => $project->title,
                                                                ]) }}"
