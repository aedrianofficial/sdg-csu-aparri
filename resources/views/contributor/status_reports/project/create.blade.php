            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Create Status Report for '{{ request('related_title') }}'
                        @if (request('related_type') == Project::class)
                            Projects/Programs
                        @elseif (request('related_type') == Research::class)
                            Research
                        @endif
                    </h3>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('contributor.status_reports.store_project') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="log_status" name="log_status" class="form-control"
                                        @if (array_key_exists($project->status_id, $statusesToCheck)) value="{{ $statusesToCheck[$project->status_id] }}"
        @else
            value="" @endif
                                        readonly required>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="status_report_file" class="form-label">Upload Status Report File(Maximum of
                                        2mb)</label>
