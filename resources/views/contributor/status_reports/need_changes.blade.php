                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('contributor.status_reports.need_changes') }}" method="GET" class="mb-4">
                                <div class="row">
                                    <!-- Title Filter -->
                                        ...
                                        <tbody>
                                            @foreach ($reports as $report)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('contributor.status_reports.edit', $report->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
